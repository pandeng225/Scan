...
$.layer({
    ...
    title: '更新物流单号',
    maxmin: true,
    iframe: {src : '${rc.contextPath}/admin/am/delivery/updateExpressId?orderId='+oid},
    area: ['400px' , '220px'],
    end: function(){
...
<div class="breadcrumbW">
  <div class="breadcrumb">
    <span class="left">订单管理&nbsp;&gt;&nbsp;修改物流单</span>
  </div>
</div>
    <!--end curmb-->
<!--begin main content-->
    <div class="listW">
        ...
        <!--begin right content-->
        <ul class="sList">
			<@form.form method="post" action="${rc.contextPath}/admin/am/delivery/queryRollback">
            	<li>
            		<span>订单标识</span>
      ...
      <div class="tableBody" cellpadding="0" cellspacing="0" border="0" width="100%"  style="margin-bottom: 7px;"> 
		                  ...
		                  <#list pager.rows as item>
		                   <tr>
		                    ...
		                    <td class="others">
		                    	...
		                    	<a class="cBlue" style="cursor:pointer;" href="javascript:void(0);" onclick="updateExpressId('${item.ORDER_ID}')">修改单号</a>
		                    	<#else>
		                    	电子运单，不可修改
		                    	</#if>
		                    </td>
                ...
                <#import "/admin/layout/common/pager.ftl" as q>
		  		<@q.pager pageNo=pager.curPage pageSize=pager.pageSize recordCount=pager.total toURL="${rc.contextPath}/admin/am/delivery/queryRollback"/>
