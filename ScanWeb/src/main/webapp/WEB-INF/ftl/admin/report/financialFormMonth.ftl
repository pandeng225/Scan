...
<script>
function exportXls(){
 window.open('${rc.contextPath}/admin/am/report/financial/exportFMS?monthTime='+$("#monthTime").val());
}
</script>
<!--begin crumb-->
<div class="rightBar">
...
<!--begin main content-->
    <div class="listW">
        <!--begin right content-->
        <ul class="sList">
			<@form.form method="post" action="${rc.contextPath}/admin/am/report/financial/queryFMS">
            		<li>
	            		<label>月份：&nbsp;</label>
