...
<div class="navigation">
    <div class="navigationLeft">
        商品管理<span>&gt;</span>添加相册图片
    </div>
</div>
<@form.form method="post" id="addAlbumForm" action="${rc.contextPath}/admin/am/album/add">
...
<div class="fSection">
    ...
    <table cellspacing="10" cellpadding="0" border="0" class="sTable">
        ...
        <tr>
            ...
            <td>
                <input id="albumExplain" name="albumExplain" type="text" class="inputStyle w420 mrgR10" onblur="validationAlbumExplain();">
            ...
            <td>
                <select name="usedChannel" id="usedChannel" class="selectStyle w200">
                    <#list usedChannleList as uc>
                        <option value="${uc.dataKey}" <#if uc.dataValue == usedChannel>selected="selected"</#if> >${uc.dataValue}</option>
                    </#list>
                </select>
            </td>
        </tr>
    ...
    <div class="picture_information">
        ...
        <div class="upload_img">
            ...
            <div class="upload_content">
                ...
                <#list goodsBean.images as image>
                    <li>
                        <input type="hidden" id="img${image_index+1}" name="imgs" value="${image.imageUrl}" index= "${image_index+1}" biggerThanH="${image.biggerThanH}"/>
                        <label>
                            <img id="imgShow${image_index+1}" style="width:85px; height:85;overflow:hidden;" width="85" height="85" src="${viewPath}${image.imageViewUrl}" />
                        </label>
    ...
    <div class="submitBox">
        ...
        <input type="button" id="albumCreateBtn" class="longWhiteSubmitBtn onlySave" value="保存" />
    </div>
</div>
</@form.form>
                ...
                new AjaxUpload($("#upload_button"+i),{
                    ...
                    onComplete: function(file, uploadResult){
                        if(uploadResult.key == 'extNameError'){
                            ...
                            GoodsImageMacro.showErrors("上传图片异常");
                            return;
