...
<!--begin main content-->
    <div class="listW">
        ...
        <!--begin right content-->
        <ul class="sList">
			<@form.form method="post" action="${rc.contextPath}/admin/am/order/sendGoods">
            		<li>
	            		<label>订单标识&nbsp;</label>
      ...
      <div class="tableBody" cellpadding="0" cellspacing="0" border="0" width="100%"  style="margin-bottom: 7px;"> 
	      			   ...
	      			   <tbody>
		                  <#list pager.rows as item>
		                   <tr>
		                    ...
		                    <td class="others">
		                    	<a class="cBlue" style="cursor:pointer;" href="${rc.contextPath}/admin/am/delivery/detail?orderId=${item.ORDER_ID}")">发货</a>
                ...
                <#import "/admin/layout/common/pager.ftl" as q>
		  		<@q.pager pageNo=pager.curPage pageSize=pager.pageSize recordCount=pager.total toURL="${rc.contextPath}/admin/am/order/sendGoods"/>
