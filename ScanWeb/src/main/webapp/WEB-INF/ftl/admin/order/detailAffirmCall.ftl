...
<script language="javascript" type="text/javascript">
    ...
    function affirmCall(id) {
//alert(id);
        var CSRFToken = $("input[name=CSRFToken]").val();
        var desc = $("#desc").val();
        $.ajax({
            url: "${rc.contextPath}/admin/am/order/affirmCallCommit",
            type: "POST",
            async: false,
            data: {"orderId": id,"desc":desc, "CSRFToken": CSRFToken},
            success: function (data) {
                if (data.result == "success") {
                    alert(data.msg);
                    window.location.href = "${rc.contextPath}/admin/am/order/affirmCall"
                } else {
                    alert(data.msg);
                }
            }
    ...
    function qryPost() {
        ...
        $.ajax({
            ...
            async: true,
            data: {
                "eid": '${orderDataPost.EXPRESS_ID}',
                "ename": '${orderDataPost.EXPRESS_COMPNAY}',
                "CSRFToken": CSRFToken
            },
            success: function (data) {
                if (data.status) {
...
<div class="rightBar">
    <div class="breadcrumbW">
        <div class="breadcrumb">
            <span class="left">订单管理&nbsp;&gt;&nbsp;订单详情&nbsp;&gt;&nbsp;订单外呼确认</span>
        </div>
    </div>
    ...
    <!--
    <div id="process" class="section4" style="margin-left: 20px;">
        ...
        <div class="proce wait" id="parttwo">
            <ul>
            <li class="tx1"> </li>
            </ul>
        </div>
        <div class="node wait" id="partthree">
        <ul>
            <li class="tx1"> </li>
            <li class="tx2">待分配</li>
        ...
        <div class="proce wait" id="partfour">
            <ul>
            <li class="tx1"> </li>
            </ul>
        </div>
        <div class="node wait" id="partfive">
            <ul>
                <li class="tx1"> </li>
                <li class="tx2">订单补录</li>
                <li id="track_time_1" class="tx3">
                </li>
            </ul>
        </div>
        <div class="proce wait" id="partsix">
            <ul>
            <li class="tx1"> </li>
            </ul>
        </div>
        <div class="node wait" id="partseven">
            <ul>
                <li class="tx1"> </li>
                <li class="tx2">待发货</li>
        ...
        <div class="proce wait" id="parteight">
            <ul>
            <li class="tx1"> </li>
            </ul>
        </div>
        <div class="node wait" id="partnine">
            <ul>
                <li id="promise_time_2" class="tx1"></li>
                <li class="tx2">发货中</li>
                <li class="tx3"> </li>
            </ul>
        </div>
        <div class="proce wait" id="partten">
            <ul>
            <li class="tx1"> </li>
            </ul>
        </div>
        <div class="node wait" id="partenleven">
            <ul>
                <li id="promise_time_2" class="tx1"></li>
                <li class="tx2">物流在途</li>
                <li class="tx3"> </li>
            </ul>
        </div>
        <div class="proce wait" id="parttwelve">
            <ul>
            <li class="tx1"> </li>
            </ul>
        </div>
        <div class="node wait" id="partthirteen">
            <ul>
                <li id="promise_time_2" class="tx1"></li>
                <li class="tx2">成功关闭</li>
                <li class="tx3"> </li>
            </ul>
        </div>
    </div>
                        ...
                        <tr>
                            ...
                            <th width="12%">商品组成
                                &nbsp;<a class="cBlue" style="cursor:pointer;"
                                         href="${rc.contextPath}/admin/am/order/updateOrderdetail?orderIdStr=${orderDataBase.orderId}"
                                         )">更新商品信息</a>
                            </th>
                            <!--
                            <th width="42%"> 商品名称 </th>
	...
	-->
        ...
        <@form.form>
            <div style="margin-bottom: 15px; padding-top: 10px;text-align:center;">
                <div style="text-align: left"><span>备注：</span><input id="desc"/></div>
                <a class="longBlueSubmitBtn" href="javascript:affirmCall(${orderDataBase.orderId});"
                   style="margin-top: 10px">外呼确认</a>
            </div>
        </@form.form>
</@layout>