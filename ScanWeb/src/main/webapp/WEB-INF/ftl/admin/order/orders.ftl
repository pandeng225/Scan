...
<div class="breadcrumbW">
  <div class="breadcrumb">
    <span class="left">订单管理&nbsp;&gt;&nbsp;订单查询</span>
  </div>
</div>
    <!--end curmb-->
<!--begin main content-->
    <div class="listW">
			...
			<@form.form method="post" action="${rc.contextPath}/admin/am/order/queryAllOrders">
            		...
            		<li>
	            		...
	            		<select id="orderState" class="inputStyle w180" name="orderState" tabindex="1" style="margin-left:6px;">   	
			            	...
			            	<#--<option value="09">订单处理退单</option>-->
			            	<#--<option value="10">客户拒收退单</option>-->
      ...
      <div class="tableBody" cellpadding="0" cellspacing="0" border="0" width="100%"  style="margin-bottom: 7px;"> 
		                  ...
		                  <#list pager.rows as item>
		                   <tr>
		                  	<td class="first">
                                ...
                                <p class="bottom">店铺名称：${item.STORE_NAME}</p>
		                  	</td>
		                    <td class="others">
		                    ...
		                    <td style="text-align:left;" class="others">
		                    	<p>
		                    		姓&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;名:${item.RECEIVER_NAME?default('&nbsp;')}
		                    	</p>
		                    	<p>手机号码:${item.MOBILE_PHONE?default('&nbsp;')} </p>
                ...
                <#import "/admin/layout/common/pager.ftl" as q>
		  		<@q.pager pageNo=pager.curPage pageSize=pager.pageSize recordCount=pager.total toURL="${rc.contextPath}/admin/am/order/queryAllOrders"/>
