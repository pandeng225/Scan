...
public class SmsInterface {
    ...
    public Integer getSmsNoticeId() {
        return smsNoticeId;
    }

    public void setSmsNoticeId(Integer smsNoticeId) {
    ...
    public void setSmsSendObject(String smsSendObject) {
        this.smsSendObject = smsSendObject == null ? null : smsSendObject.trim();
    }
    ...
    public void setRecvObject(String recvObject) {
        this.recvObject = recvObject == null ? null : recvObject.trim();
    }
    ...
    public void setSmsTypeCode(String smsTypeCode) {
        this.smsTypeCode = smsTypeCode == null ? null : smsTypeCode.trim();
    }
    ...
    public void setSmsKindCode(String smsKindCode) {
        this.smsKindCode = smsKindCode == null ? null : smsKindCode.trim();
    }
    ...
    public void setNoticeContentType(String noticeContentType) {
        this.noticeContentType = noticeContentType == null ? null : noticeContentType.trim();
    }
    ...
    public void setForceObject(String forceObject) {
        this.forceObject = forceObject == null ? null : forceObject.trim();
    }
    ...
    public void setReferStaffId(String referStaffId) {
        this.referStaffId = referStaffId == null ? null : referStaffId.trim();
    }
    ...
    public void setReferDepartId(String referDepartId) {
        this.referDepartId = referDepartId == null ? null : referDepartId.trim();
    }
    ...
    public void setDealStaffid(String dealStaffid) {
        this.dealStaffid = dealStaffid == null ? null : dealStaffid.trim();
    }
    ...
    public void setDealDepartid(String dealDepartid) {
        this.dealDepartid = dealDepartid == null ? null : dealDepartid.trim();
    }
    ...
    public void setRevc1(String revc1) {
        this.revc1 = revc1 == null ? null : revc1.trim();
    }
    ...
    public void setRevc2(String revc2) {
        this.revc2 = revc2 == null ? null : revc2.trim();
    }
    ...
    public void setRevc3(String revc3) {
        this.revc3 = revc3 == null ? null : revc3.trim();
    }
    ...
    public void setRevc4(String revc4) {
        this.revc4 = revc4 == null ? null : revc4.trim();
    }
