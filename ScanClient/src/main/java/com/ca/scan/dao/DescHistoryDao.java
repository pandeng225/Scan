...
/** 
 * DAO for table DESC_HISTORY.
*/
public class DescHistoryDao extends AbstractDao<DescHistory, Long> {

    public static final String TABLENAME = "DESC_HISTORY";

    /**
     * Properties of entity DescHistory.<br/>
    ...
    */
    ...
    public DescHistoryDao(DaoConfig config) {
        super(config);
    }
    
    public DescHistoryDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'DESC_HISTORY'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, DescHistory entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(DescHistory entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(DescHistory entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
