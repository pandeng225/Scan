...
public class Capture extends Activity implements Callback {
	...
	public void handleDecode(Result result, Bitmap barcode) {
		...
		if (resultString.equals("")) {
			Toast.makeText(Capture.this,R.string.scan_error, Toast.LENGTH_SHORT).show();
		}else {
			//TODO 网络连接待开发
			Toast.makeText(Capture.this, R.string.update_success, Toast.LENGTH_SHORT).show();
		}
	}
